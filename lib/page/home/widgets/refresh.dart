...
class IceCreamIndicator extends StatefulWidget {
  ...
  const IceCreamIndicator(this.child,{
    Key key,
  }) : super(key: key);
...
class _IceCreamIndicatorState extends State<IceCreamIndicator>
  ...
  static const _assets = <ParalaxConfig>[
    ...
    ParalaxConfig(
      image: AssetImage("assets/ice1.png"),
      level: 3,
    ),
    ParalaxConfig(
      image: AssetImage("assets/ice3.png"),
      level: 4,
    ),
    ParalaxConfig(
    ...
    ParalaxConfig(
      image: AssetImage("assets/mint.png"),
      level: 5,
    ),
  ];

  static const _indicatorSize = 95.0;
